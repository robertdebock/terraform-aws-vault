...
vault_path = getenv("VAULT_PATH", "/opt/vault")
...
default_alarms = {
    ...
    'AWS/EC2': [
        ...
        #         [alarm_identifier, 'AWS/EC2', 'CPUUtilization', 'GreaterThanThreshold', '1m', 'Average', 'default1']),
        ...
        'Amazon Linux': [
            {
                'Key': alarm_separator.join(
                    [alarm_identifier, cw_namespace, 'disk_used_percent', 'device', 'nvme0n1p1', 'fstype', 'xfs', 'path',
                     '/', 'GreaterThanThreshold', '1m', 'Average', 'default1']),
                'Value': alarm_disk_used_percent_threshold
            },
            {
                'Key': alarm_separator.join(
                    [alarm_identifier, cw_namespace, 'disk_used_percent', 'device', 'nvme1n1', 'fstype', 'ext4', 'path',
                     vault_path, 'GreaterThanThreshold', '1m', 'Average', 'default1']),
                'Value': alarm_disk_used_percent_threshold
            },
            {
                'Key': alarm_separator.join(
                    [alarm_identifier, cw_namespace, 'mem_used_percent', 'GreaterThanThreshold', '1m', 'Average', 'default1']),
                'Value': alarm_memory_high_default_threshold
            }
        ],
        'Red Hat': [
